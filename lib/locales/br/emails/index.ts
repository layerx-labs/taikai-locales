export default {
  ...
  'participant-registration-rejected': {
    ...
    preheader: 'Sua participação no {{challengeName}} foi rejeitada',
  },
  ...
  'invite-to-project-mentor': {
    subject: 'TAIKAI Garden - Você foi convidado para ser mentor no projeto {{projectName}}',
    preheader: 'TAIKAI Garden - Você foi convidado para ser mentor no projeto {{projectName}}',
  },
  'invite-to-garden-project': {
    subject: 'TAIKAI Garden - Você foi convidado para ser membro do projeto {{projectName}}',
    preheader: 'TAIKAI Garden - Você foi convidado para ser membro do projeto {{projectName}}',
  },
  ...
  'challenge-closed-hackers-delayed': {
    subject: 'TAIKAI - Este não é o fim do seu projeto',
    preheader:
      'O hackathon pode ter terminado, mas a jornada do seu projeto não tem de ficar por aqui',
  },
  'challenge-closed-org-admins': {
    subject: 'Obrigado por escolher a TAIKAI',
    preheader: 'Gostaríamos muito de saber a sua opinião sobre a experiência geral com a TAIKAI.',
  },
};
