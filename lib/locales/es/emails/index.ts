export default {
  ...
  'allocate-received': {
    subject: 'TAIKAI - ¡Has recibido VOTEs!',
    preheader: 'Has recibido {{amount}} VOTEs para respaldar proyectos',
  },
  'back-success': {
    subject: 'TAIKAI - ¡Has respaldado un proyecto!',
    preheader: 'Respaldo de {{amount}} VOTEs a {{projectName}} confirmado',
  },
  'challenge-transfer-received': {
    subject: 'TAIKAI - Has recibido fondos para respaldar proyectos en TAIKAI',
    preheader: 'Transferencia de {{amount}} VOTEs en {{challengeName}} de {{from}} recibida',
  },
  'challenge-transfer-sent': {
    subject: 'TAIKAI - Has enviado fondos para respaldar proyectos',
    preheader:
      'La transferencia de {{amount}} VOTEs en {{challengeName}} a {{to}} se ha confirmado con éxito',
  },
  'received-dividend': {
    subject: 'TAIKAI - Has recibido una recompensa',
    preheader: 'Recompensa de {{amount}} LXs recibida por ser jurado',
  },
  'back-failed': {
  ...
  'challenge-transfer-sent-failed': {
    ...
    preheader: 'La transferencia de {{amount}} LXs en {{challengeName}} a {{to}} falló',
  },
  'transfer-sent-failed': {
    subject: 'TAIKAI - No se pudieron transferir los fondos',
    preheader: 'La transferencia global de {{amount}} LXs a {{to}} falló',
  },
  'market-place-order': {
  ...
  'transfer-sent': {
    subject: 'TAIKAI - ¡Has enviado LXs!',
    preheader: 'Transferencia global de {{amount}} LXs a {{to}} enviada exitosamente',
  },
  'transfer-received': {
    subject: 'TAIKAI - ¡Has recibido LXs!',
    preheader: 'Transferencia global de {{amount}} LXs por parte de {{from}} recibida',
  },
  'deposit-received': {
    subject: 'TAIKAI - ¡Has recibido LXs!',
    preheader: 'Depósito de {{amount}} LXs recibido',
  },
  'invite-to-project': {
  ...
  'participant-registration-rejected': {
    subject: 'TAIKAI - Tu participación en {{challengeName}} fue rechazada',
    preheader: 'Tu participación en {{challengeName}} fue rechazada',
  },
  ...
  'friend-referral-confirmed': {
    ...
    preheader: 'Como has completado otra referencia, recibirás {{amount}} LXs',
  },
  mail: {
  ...
  'invite-to-garden-project': {
    subject: 'TAIKAI Garden - Has sido invitado a ser miembro del proyecto {{projectName}}',
    preheader: 'TAIKAI Garden - Has sido invitado a ser miembro del proyecto {{projectName}}',
  },
  ...
  'challenge-closed-hackers-delayed': {
    subject: 'TAIKAI - Este no es el fin de tu proyecto de hackathon',
    preheader:
